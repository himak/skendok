<aside class="main-sidebar">
    <section class="sidebar" style="height: auto;">
        <ul class="sidebar-menu tree" data-widget="tree">
            ...
            @endcan
            @can('odosielatel_access')
                <li class="{{ request()->is("admin/odosielatels") || request()->is("admin/odosielatels/*") ? "active" : "" }}">
                    <a href="{{ route("admin.odosielatels.index") }}">
                        <i class="fa-fw fas fa-cogs">

                        </i>
                        <span>{{ trans('cruds.odosielatel.title') }}</span>

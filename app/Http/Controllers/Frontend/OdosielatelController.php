...
class OdosielatelController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.odosielatels.index', compact('odosielatels'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.odosielatels.create');
    }
    ...
    public function store(StoreOdosielatelRequest $request)
    {
        ...
        return redirect()->route('frontend.odosielatels.index');
    }
    ...
    public function edit(Odosielatel $odosielatel)
    {
        ...
        return view('frontend.odosielatels.edit', compact('odosielatel'));
    }
    ...
    public function show(Odosielatel $odosielatel)
    {
        ...
        return view('frontend.odosielatels.show', compact('odosielatel'));
    }
